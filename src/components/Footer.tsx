const Footer = () => {
  ...
  return (
    <footer className="relative bg-gradient-to-br from-amber-950 via-amber-900 to-amber-950 text-white overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20">
        ...
        <div className="absolute bottom-20 right-10 w-80 h-80 rounded-full bg-gradient-to-l from-amber-500/30 to-transparent blur-3xl animate-pulse-slow" style={{ animationDelay: "1s" }} />
      </div>
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            <h3 className="text-4xl font-display font-bold mb-4 bg-gradient-to-r from-amber-200 to-amber-400 bg-clip-text text-transparent">
              ChocoElite
            </h3>
            <p className="text-lg text-amber-100/90 leading-relaxed mb-6 max-w-md">
          ...
          <div>
            ...
            <nav className="space-y-3">
              <a
                href="#about"
                className="block text-amber-100/80 hover:text-white transition-all duration-300 hover:translate-x-2 font-medium"
              >
                → About Us
              </a>
              <a
          ...
          <div>
            ...
            <address className="not-italic space-y-4 text-amber-100/80">
      ...
      {/* Decorative Elements */}
      <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-amber-700 via-amber-500 to-amber-700"></div>
    </footer>
  );
};
